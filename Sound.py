...
def initSound():
    ...
    placeSound = pygame.mixer.Sound(os.path.join("sounds", "place.wav"))
    forcedSound = pygame.mixer.Sound(os.path.join("sounds", "forced.wav"))
    badplaceSound = pygame.mixer.Sound(os.path.join("sounds", "badplace.wav"))
    badmoveSound = pygame.mixer.Sound(os.path.join("sounds", "badmove.wav"))
    gameoverSound = pygame.mixer.Sound(os.path.join("sounds", "gameover.wav"))
    removedSound = pygame.mixer.Sound(os.path.join("sounds", "removed.wav"))
    gothighSound = pygame.mixer.Sound(os.path.join("sounds", "gothigh.wav"))
